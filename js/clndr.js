 ...
 */ (function(factory) {
            ...
            if (this.options.constraints.startDate) {
                ...
                if (this.options.lengthOfTime.days) {
                    ...
                    if (this.intervalStart.isBefore(constraintStart, 'month')) {
                        ...
                        this.month.set('month', constraintStart.month())
                            .set('year', constraintStart.year());
                    }
            ...
            if (this.options.constraints.endDate) {
                ...
                if (this.options.lengthOfTime.days) {
                    ...
                    if (this.intervalEnd.isAfter(constraintEnd, 'month')) {
                        this.intervalEnd.set('month', constraintEnd.month())
                            .set('year', constraintEnd.year());
                        this.month.set('month', constraintEnd.month())
                            .set('year', constraintEnd.year());
                    }

                    // Check if the starting interval is later than the ending.
                    if (this.intervalStart.isAfter(constraintEnd, 'month')) {
                        this.intervalStart.set('month', constraintEnd.month())
                            .set('year', constraintEnd.year());
                    }
                }
            }
    ...
    Clndr.prototype.validateOptions = function() {
        ...
        if (this.options.weekOffset > 6 || this.options.weekOffset < 0) {
            console.warn('clndr.js: An invalid offset ' + this.options.weekOffset + ' was provided (must be 0 - 6); using 0 instead.');
    ...
    Clndr.prototype.render = function() {
        ...
        if (this.options.lengthOfTime.days) {
            ...
            for (i = 0; i < this.options.lengthOfTime.months; i++) {
                currentIntervalStart = this.intervalStart.clone()
                    .add(i, 'months');
                currentIntervalEnd = currentIntervalStart.clone()
                    .endOf('month');
    ...
    Clndr.prototype.bindEvents = function() {
        ...
        var eventType = this.options.useTouchEvents === true ? 'touchstart' : 'click';
        var eventName = eventType + '.clndr';

        // Make sure we don't already have events
        $container.off(eventName, '.' + targets.day)
        ...
        $container.on(eventName, '.' + targets.day, function(event) {
            ...
            if (self.options.trackSelectedDate && !(self.options.ignoreInactiveDaysInSelection && $currentTarget.hasClass(classes.inactive))) {
        ...
        $container.on(eventName, '.' + targets.todayButton, data, this.todayAction)
    ...
    Clndr.prototype.back = function(options /*, ctx */ ) {
        ...
        if (timeOpt.days) {
            ...
            ctx.intervalStart.subtract(timeOpt.interval, 'days')
                .startOf('day');
            ...
            ctx.intervalStart.subtract(timeOpt.interval, 'months')
                .startOf('month');
            ctx.intervalEnd = ctx.intervalStart.clone()
    ...
    Clndr.prototype.forward = function(options /*, ctx */ ) {
        ...
        if (ctx.options.lengthOfTime.days) {
            // Shift the interval in days
            ctx.intervalStart.add(timeOpt.interval, 'days')
                .startOf('day');
            ctx.intervalEnd = ctx.intervalStart.clone()
                .add(timeOpt.days - 1, 'days')
                .endOf('day');
            ...
            // Shift the interval by a month (or several months)
            ctx.intervalStart.add(timeOpt.interval, 'months')
                .startOf('month');
            ctx.intervalEnd = ctx.intervalStart.clone()
                .add(timeOpt.months || timeOpt.interval, 'months')
                .subtract(1, 'days')
    ...
    Clndr.prototype.setMonth = function(newMonth, options) {
        ...
        if (timeOpt.days || timeOpt.months) {
            console.warn('clndr.js: You are using a custom date interval. ' + 'Use Clndr.setIntervalStart(startDate) instead.');
            return this;
        }
